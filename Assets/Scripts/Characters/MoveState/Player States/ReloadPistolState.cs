...
public class ReloadPistolState : MoveState
{
    private PlayerManager player;
    private WeaponManager wm;

    public ReloadPistolState(GameObject caller, WeaponManager weapon) : base(caller)
    {
        wm = weapon;
    ...
    protected override void Initialize(GameObject caller)
    {
        ...
        player.Sprite.Action = AnimAction.ReloadPistol;
